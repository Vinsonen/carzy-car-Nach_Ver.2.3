...
button_no_rect = pygame.Rect(button_dialog_x+button_dialog_width+100, button_dialog_y, button_dialog_width, button_dialog_height)
...
def run_simulation(genomes, config):
    ...
    while True:
        ...
        if show_dialog:
            ...
            Interface.draw_button(screen,"Yes",(0,0,0),(0,255,0),button_dialog_x,button_dialog_y,button_dialog_width,button_dialog_height,button_yes_rect)
            Interface.draw_button(screen,"No",(0,0,0),(255,0,0),button_dialog_x+button_dialog_width+100,button_dialog_y,button_dialog_width,button_dialog_height,button_no_rect)



        Interface.draw_button(screen,text1, text_color,button_color,positionx,positiony,button_width,button_height,button_regelung1_rect)
        Interface.draw_button(screen, text2, text_color, button_color, positionx, positiony+button_height+30, button_width,
...
def data_text(cars):
 ...
 \
            ...
            f"abstand: {Interface.getabstandrechts1(), Interface.getabstandvorne1(), Interface.getabstandlinks1()}\n   \n " + \
 \
