...
def run_simulation(genomes, config):
    ...
    for i, g in genomes:
        ...
        # _init__(self, position, carangle, fwert, speed_set, radars,  bit_volt_wert_list, distance, time)
        # position anfang:[790 * f, 825 * f]  [210 * f, 250 * f], [632 * f, 682 * f]310°
    new_car = Car([790 * f, 825 * f], 0, 28, False, [], [], 0, 0)
    cars.append(new_car)
...
def data_text(cars):
 ...
 \
            ...
            f"Fahr wert: {car.power}\n    " + \
            f"rad_angle: {car.radangle:.2f}\n    " + \
 \
