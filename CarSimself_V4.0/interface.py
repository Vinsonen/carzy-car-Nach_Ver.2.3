    ...
    def regelungtechnik_python(cars):
        for i, car in enumerate(cars):
            if car.radars_enable and car.regelung_enable:
                ...
                # Richtung
                kp2 = 0.9948087226407794
                if distcm[0] < 130 or distcm[2] < 130:
                    sollwert4 = 0
                    diff = distcm[2] - distcm[0]
                    # car.radangle = (diff-sollwert4)* kp2
                    car.swert = (-1)*(diff-sollwert4) * kp2  # gleich mit C

                # Geschwindigkeit
                k1 = 1.1155175158518325
                k2 = 1.0983418475131987
                k3 = 1.1149174658597132
                kp1 = 0.9899236909562186
                ...
                if distcm[1] > 100:
                    ...
                    # car.radangle = (distcm[0] - distcm[2]) * kp2
                    car.swert = (-1)*(distcm[0] - distcm[2]) * kp2
